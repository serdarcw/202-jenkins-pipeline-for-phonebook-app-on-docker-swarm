...
//aws ec2 describe-instances --region us-east-1 --instance-ids i-06292fe3931de5fed --query 'Reservations[*].Instances[*].[PublicIpAddress]' --output text | sed "s/\\s*None\\s*//g"
                script {
